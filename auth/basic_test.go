...
func TestBasic_Authorised(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got, want := basicAuth.AuthorizedHTTP(tt.req, tt.res, nil, ""), tt.out; !reflect.DeepEqual(got, want) {
...
func TestBasic_Authorized_should_set_www_realm_header(t *testing.T) {
	...
	_ = basicAuth.AuthorizedHTTP(&http.Request{Header: http.Header{}}, rw, nil, "")
